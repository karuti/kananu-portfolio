...
- **Engagement:** 40%+ engagement rates (vs 21% industry average)
...
- New users received no welcome sequence
- No automated follow-up after purchase
- Missing re-engagement campaigns for dormant users
...
To capture and convert new users immediately, I designed a strategic multi-stage engagement journey starting with a welcome discount reward.
Other initiative implemented in this flow included:
- Browse abandonment intervention
- Post-purchase engagement
- Dormant user re-activation
...
- 26% engagement rate (vs 21% industry average)
...
4. **Win-Back:** Re-engagement for dormant users
...
**Engagement Metrics:**
- **Engagement Rates:** 45-60% (vs 21% industry average)
